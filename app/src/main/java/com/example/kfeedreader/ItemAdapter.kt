...
class ItemAdapter(private val list: ArrayList<MainActivity.Item>, private val context: Context):
    ...
    override fun onBindViewHolder(holder: ItemViewHolder, position: Int) {
        ...
        holder.data.text = SimpleDateFormat("dd/MM/yyyy", Locale("pt", "BR"))
            .format(Date(list[position].data))
    ...
    class ItemViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        val title = view.findViewById(R.id.titulo) as TextView
        val autor = view.findViewById(R.id.autor) as TextView
        val data = view.findViewById(R.id.dataPub) as TextView
